...
#define NX_DHCPV6_SERVER_DUID_VENDOR_ASSIGNED_ID	"cosmosdevboard"
...
#define NX_DHCPV6_SERVER_DUID_VENDOR_PRIVATE_ID 	0x20251109
...
#define NX_DHCP_SERVER_NAME            "Cosmos Dev Board DHCP Server"

...
static TX_BYTE_POOL valueNotSetted;
...
VOID tx_application_define(VOID *first_unused_memory)
{
  ...
  if (tx_byte_pool_create(&valueNotSetted, "Tx App memory pool", tx_byte_pool_buffer, TX_APP_MEM_POOL_SIZE) != TX_SUCCESS)
  {
  ...
  else
  {
    ...
    memory_ptr = (VOID *)&valueNotSetted;
  ...
  if (tx_byte_pool_create(&valueNotSetted, "Fx App memory pool", fx_byte_pool_buffer, FX_APP_MEM_POOL_SIZE) != TX_SUCCESS)
  {
  ...
  if (tx_byte_pool_create(&valueNotSetted, "Nx App memory pool", nx_byte_pool_buffer, NX_APP_MEM_POOL_SIZE) != TX_SUCCESS)
  {
  ...
  if (tx_byte_pool_create(&valueNotSetted, "Ux App memory pool", ux_device_byte_pool_buffer, UX_DEVICE_APP_MEM_POOL_SIZE) != TX_SUCCESS)
  {
